...
public class BoletaSolicitudDocente extends BoletaSolicitud {
     ...
     */
    public BoletaSolicitudDocente(Curso cursoSolicitante, Date fecha, 
            TipoDocumento tipoDoc, int cantOriginales, int cantJuegos , Empleado solicitante) {
        super(fecha, tipoDoc, cantOriginales, 
                cantJuegos, solicitante);
